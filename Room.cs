public class room {
  ...
  public void roomData(){
    Console.WriteLine("Room Number: " + val);
    Console.WriteLine("Above: " + above);
    Console.WriteLine("Bellow: " + bellow);
    Console.WriteLine("Top Left: " + leftTop);
    Console.WriteLine("Top right: " + rightTop);
    Console.WriteLine("Bottom Left: " + leftBot);
    Console.WriteLine("Bottom Right: " + rightBot);
    Console.WriteLine("  " + above);
    Console.WriteLine(leftTop + "   " + rightTop);
    Console.WriteLine("  " + val);
    Console.WriteLine(leftBot + "   " + rightBot);
